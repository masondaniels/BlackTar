...
public class GL {
	 ...
	 * 
	 * Documentation for static WebGL values can be found at:
	...
	public static final int UNSIGNED_BYTE = 0x1401; // Same value as pixel type
...
//	public static final int UNSIGNED_BYTE = 0x1401;
	...
	// Shader precision-specified type
